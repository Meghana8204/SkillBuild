...
const { signup, login, listInstitutions } = require("../controllers/authController");
...
router.post(
  ...
  [
    ...
    body("institutionName").optional({ nullable: true, checkFalsy: true }).trim().notEmpty()
      .withMessage("Institution name must not be empty")
  ],
  validate,
  signup
);
